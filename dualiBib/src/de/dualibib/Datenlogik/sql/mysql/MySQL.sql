...
DROP SCHEMA IF EXISTS dualibib CASCADE;
...
CREATE TABLE Medien(
mm_ID BIGINT AUTO_INCREMENT,
m_Titel VARCHAR(150),
_Author VARCHAR(150),
mm_ISBN VARCHAR(24) UNIQUE,
m_Barcodenummer BIGINT UNIQUE,
...
-- Testinserts
INSERT INTO User(u_Vorname, u_Nachname, u_Login, u_passwd, u_Strasse, u_Hausnummer, u_PLZ, u_Ort)
VALUES ('vor', 'nach', 'user', 'pw', 'Testweg', 12, 22554, 'Testdorf')
